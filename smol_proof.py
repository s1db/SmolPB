def make_smol(file_name, read_dir, save_dir, loud=False):
    ...
    for constraint in graph_dict:
        print(constraint, graph_dict[constraint])
...
if "__main__" == __name__:
    make_smol("rup_php65", "test_instances/interesting_proofs/", "test_instances/interesting_proofs/", loud=True)