...
// configuration step. It creates a namespace called `SmolPB`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", SmolPB::cmake::project_name, SmolPB::cmake::project_version) };
